...
{
    public partial class FormCapNhatPhanCong : Form
    {
        ...
        public FormCapNhatPhanCong(RoleTablePrivilege roleTabPriv, DataGridViewRow row, List<string> colsCanBeUpdated)
        {
            InitializeComponent();
        ...
        private void FormCapNhatPhanCong_Load(object sender, EventArgs e)
        {
